...
def Instfolme():
    user1 = 'jalexmcarthur' #input("Please enter your UserName: ")
    pass1 = 'Origami01' #input("Please enter your Password: ")
    id1 = user1 #input("Please enter your Instagram ID (might be same as UserName):")
    #start driver
    ...
    try:
        ...
        iGClick = driver.find_element(By.XPATH,'/html/body/span/section/main/div/header/section/ul/li[3]/a')
        iGClick.click()
        time.sleep(2)
